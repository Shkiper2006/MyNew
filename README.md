...
> Важно: для установки зависимостей используйте Python 3.12 или 3.13.  
> На Python 3.14 `pydantic-core` пока не имеет готовых бинарных колёс и пытается собираться из исходников через Rust, что приводит к ошибке сборки.
